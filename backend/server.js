...
const time_slots = ["12:00am - 1:00am","1:00am - 2:00am","2:00am - 3:00am","3:00am - 4:00am"
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    let isWhereZip = /^\d{1,5}$/.test(where);
    let body = {};
    if(!isWhereZip){ //if input is not digit
      body = {
        size: 1000,
        from: 0,
        "query": {
  ...
  for(let i = 0;i<time_slots.length;i++){
    if (timeRange == time_slots[i]){
      ...
      if(i<targetTime.getHours()){
        ...
        start_datetime_var_2 = new Date(start_datetime_var.getTime() - go_back_in_time_var * 60 * 60 *1000 - start_datetime_var.getMinutes() * 60 *1000 - start_datetime_var.getSeconds()*1000-start_datetime_var.getMilliseconds());
      }else{
        go_back_in_time_var = i - targetTime.getHours();
        start_datetime_var_2 = new Date(start_datetime_var.getTime() - (24 - go_back_in_time_var) * 60 * 60 *1000 - start_datetime_var.getMinutes() * 60 *1000 - start_datetime_var.getSeconds()*1000-start_datetime_var.getMilliseconds());
            ...
            "must" :[
              ...
              "range" : {
                "lastCommunicationTime.keyword" : {
                  "gte": time_stamp_var_2, //大于等于
                  "lt": time_stamp_var_3 //小于
                  }
              }
              }
            ]
