...
export class HeatMapTimeSlotsComponent implements OnInit {
  ...
  getDivvyStationsStatus(timeRangeSelection){
    ...
    plot_availableDocksInDivvyStations_on_heatMap(availableDocksInDivvyStations){
        ...
        for (let i = 0; i < this.stations.length; i++) {
            if((this.stations[i].totalDocks > 10 &&this.stations[i].totalDocks - this.stations[i].availableDocks)/this.stations[i].totalDocks >= 0.9){
